...
const ExperienceCard = ({ imgSrc, title, description }) => (
  <div className="bg-[rgb(245,252,255)] p-6 rounded-lg flex flex-col items-start border-b-4 border-b-[#5E3BEE]">
    <img 
      src={imgSrc} 
      alt={title} 
      className="w-20 h-14 sm:w-24 sm:h-16 object-cover rounded-lg mb-4 sm:mb-6"
    />
    <h3 className="text-xl sm:text-[23px] font-bold mb-3 sm:mb-4">
      {title}
    </h3>
...
const ExperiencePage = () => {
  ...
  return (
    <div className="mt-16 mb-16 bg-white">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-8 lg:px-16 py-12">
        <h2 className="text-3xl sm:text-4xl lg:text-[50px] font-bold mb-12 sm:mb-20">
          My Expertise
        </h2>
